...
from tests.evaluate.run_baseline import evaluate_jd, load_golden_set  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument("--task", choices=["jd", "match", "all"], default="all")
