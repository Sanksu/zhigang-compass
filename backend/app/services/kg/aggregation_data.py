...
_ALLOWED_SKILL_CATEGORIES: dict[str, set[str]] = {
    ...
    "AI与数据风险管理经理": {"AI/机器学习", "数据分析/商业", "数据库", "编程语言", "计算机基础",
                       "大数据", "安全", "工程协作", "后端"},
    # P11（2026-08-16 岗位名碎片归位新增族）：参照同类岗位配置，
    # 防新族漏配导致跨域技能不降权（test_all_families_have_cross_domain_whitelist）
    "FPGA验证": {"硬件/芯片", "编程语言", "计算机基础", "网络/协议", "智能驾驶/机器人", "测试"},
    "CFD分析工程师": {"智能驾驶/机器人", "硬件/芯片", "编程语言", "计算机基础", "数据分析/商业"},
    "OBD标定工程师": {"智能驾驶/机器人", "硬件/芯片", "编程语言", "计算机基础", "网络/协议"},
    "仪器AIT工程师": {"硬件/芯片", "测试", "编程语言", "计算机基础", "网络/协议"},
    "STEM科技教育讲师": {"工程协作", "计算机基础", "编程语言", "AI/机器学习", "数据分析/商业"},
    "UX设计师": {"前端", "编程语言", "计算机基础", "工程协作", "音视频", "移动/桌面"},
    "移动开发工程师": {"移动/桌面", "编程语言", "计算机基础", "网络/协议", "云原生/DevOps",
                   "工程协作", "测试"},
