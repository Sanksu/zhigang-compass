...
_POSITION_KEYWORDS: list[tuple[tuple[str, ...], str]] = [
    ...
    (("项目经理",), "项目经理"),
    (("创始",), "创始工程师"),
    # 鸿蒙开发族（2026-08-14 白名单补录，用户裁决）：合并前端/全栈/应用变体，
    # 复合词限定防误吸"鸿蒙生态运营"等非开发岗；配合 _TECH_STACKS 移除"鸿蒙"
    # （tech 前缀提取先于族匹配，不移除则"鸿蒙前端开发工程师"永远拼回原样）
    (("鸿蒙开发", "鸿蒙前端", "鸿蒙全栈", "鸿蒙应用"), "鸿蒙开发工程师"),
    ...
    (("计算生物学家",), "计算生物学家"),
    (("首席统计师",), "首席统计师"),
    # 2026-08-14 白名单补录（用户确认，候选文档 position_whitelist_candidates）：
    # ① STEM讲师 合并"课后STEM讲师"变体（复合词防误吸"stem工程师"）；
    # ② 统计师 修复不入图（剥壳残留未命中白名单）；
    # ③ 生物统计师 前置防被"统计师"族子串吸收（英文映射 biostatistician 落点）；
    # ④ IC验证 规范"工程师"后缀
    (("stem讲师", "stem 讲师"), "STEM讲师"),
    (("生物统计师",), "生物统计师"),
    (("统计师",), "统计师"),
    (("ic验证", "ic验证工程师"), "IC验证工程师"),
]
...
_EN_POSITION_MAP: dict[str, str] = {
    ...
    "site reliability engineer": "DevOps工程师",
    "sre": "DevOps工程师",
    ...
    "ml platform engineer": "机器学习工程师",
    "platform engineer": "DevOps工程师",
    "site reliability": "DevOps工程师",
    ...
    "network sre engineer": "DevOps工程师",
    ...
    "systems reliability engineer": "DevOps工程师",
    "reliability engineer": "DevOps工程师",
    ...
    "business intelligence engineer": "商业智能分析师",
    "business intelligence developer": "商业智能分析师",
    "bi developer": "商业智能分析师",
    "deep learning engineer": "机器学习工程师",
    ...
    "ai applied engineer": "AI应用工程师",
    "ai automation engineer": "AI应用工程师",
    "ai inference engineer": "AI应用工程师",
    "ai systems engineer": "AI应用工程师",
    "applied ai engineer": "AI应用工程师",
    "server engineer": "运维工程师",
    "server administrator": "运维工程师",
    "cloud engineer": "DevOps工程师",
    "cloud system administrator": "DevOps工程师",
