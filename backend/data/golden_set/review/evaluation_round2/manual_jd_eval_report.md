...
```json
{
  ...
  "skills_average_sample_f1": 0.7528906874290846,
  "bonus_skills_micro": {
    "tp": 55,
    "fp": 31,
    "fn": 18,
  ...
  "bonus_skills_average_sample_f1": 0.4496031746031746,
...
- r2_003: title raw=True, normalized=True; skills TP/FP/FN=['Apache Kafka', 'Docker', 'FastAPI', 'Kubernetes', 'LangChain', 'LlamaIndex', 'PyTorch', 'Python', 'Redis', 'Transformer', '检索增强生成', '模型量化']/['Embedding', '向量数据库', '异步编程', '推理加速']/['AGENT', 'Chroma', 'DeepSeek', 'Elasticsearch', 'GLM', 'Milvus', 'Qwen', 'TGI', 'vLLM'], F1=0.6486; bonus TP/FP/FN=['CUDA', 'MindIE', 'OCR', 'Triton', 'VLM', '昇腾CANN']/[]/[], F1=1.0000; education=True
...
- r2_010: title raw=False, normalized=False; skills TP/FP/FN=['C++', 'Linux', 'Python', 'ROS', '力控', '机器人动力学', '机器人运动学', '路径规划', '轨迹规划', '运动控制']/['ARM', 'EtherCAT', 'Twincat', 'X86', '人工智能']/['导纳控制', '阻抗控制'], F1=0.7407; bonus TP/FP/FN=['EtherCAT']/['Twincat']/['TwinCAT', '医疗机器人', '协作机器人', '手术机器人'], F1=0.2857; education=True
...
- r2_012: title raw=True, normalized=True; skills TP/FP/FN=['C++', 'CLIP', 'CNN', 'GAN', 'Java', 'OpenCV', 'Python', 'SAM', 'Transformer', '大语言模型', '扩散模型']/['图像生成', '模型部署']/['图像分割', '图像分类', '模型轻量化', '目标检测'], F1=0.7857; bonus TP/FP/FN=[]/[]/[], F1=0.0000; education=False
- r2_013: title raw=False, normalized=False; skills TP/FP/FN=['C++', 'Python', '三维重建', '传感器融合', '多视几何', '摄影测量']/['光束平差法', '多线程', '性能调优', '机器视觉', '深度学习', '特征匹配', '特征提取', '畸变校准']/['CNN', 'GPU加速', 'LiDAR', 'OpenCV', 'OpenMVS', 'PyTorch', 'SFM', 'Transformer', '光束平差', '密集匹配', '特征提取与匹配', '畸变校正', '相机标定'], F1=0.3636; bonus TP/FP/FN=[]/['GPU加速', '多线程']/[], F1=0.0000; education=True
...
- r2_015: title raw=False, normalized=False; skills TP/FP/FN=['Android', 'CSS3', 'HTML5', 'JavaScript', 'Vue.js', 'uni-app']/['Web', '小程序']/[], F1=0.8571; bonus TP/FP/FN=['UI设计', 'iOS']/['App混合']/['小程序', '混合'], F1=0.5714; education=True
- r2_016: title raw=True, normalized=True; skills TP/FP/FN=['Apache Kafka', 'Git', 'Gradle', 'Java', 'JavaScript', 'Linux', 'Maven', 'MongoDB', 'MySQL', 'PostgreSQL', 'RabbitMQ', 'Redis', 'RocketMQ', 'SQL', 'Spring Boot', 'Spring Cloud', 'Vue.js']/['分布式系统', '消息队列', '系统设计', '缓存']/[], F1=0.8947; bonus TP/FP/FN=['AWS', 'Docker', 'Dubbo', 'Kubernetes', 'gRPC', '分布式', '分库分表', '腾讯云', '阿里云']/['CSS', 'HTML', 'MongoDB', 'React', 'Redis']/['微服务'], F1=0.7500; education=True
- r2_017: title raw=False, normalized=False; skills TP/FP/FN=['AGENT', 'CI/CD', 'Figma', 'Go', 'Java', 'Python', 'UI设计', 'VLM', '大语言模型', '检索增强生成']/['Sketch', '性能监控']/['客户端', '知识库构建'], F1=0.8333; bonus TP/FP/FN=[]/[]/[], F1=0.0000; education=True
