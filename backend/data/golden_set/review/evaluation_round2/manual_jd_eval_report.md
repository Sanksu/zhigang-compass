...
```json
{
  ...
  "skills_average_sample_f1": 0.7566447724713413,
  "bonus_skills_micro": {
    "tp": 55,
    "fp": 33,
    "fn": 18,
  ...
  "bonus_skills_average_sample_f1": 0.45972222222222225,
...
- r2_003: title raw=False, normalized=False; skills TP/FP/FN=['Apache Kafka', 'Docker', 'FastAPI', 'Kubernetes', 'LangChain', 'LlamaIndex', 'PyTorch', 'Python', 'Redis', 'Transformer', '检索增强生成', '模型量化']/['Embedding', '向量数据库', '多模态', '推理加速']/['AGENT', 'Chroma', 'DeepSeek', 'Elasticsearch', 'GLM', 'Milvus', 'Qwen', 'TGI', 'vLLM'], F1=0.6486; bonus TP/FP/FN=['CUDA', 'MindIE', 'OCR', 'Triton', '昇腾CANN']/['多模态']/['VLM'], F1=0.8333; education=True
- r2_004: title raw=False, normalized=False; skills TP/FP/FN=['Perl', 'Tcl', '布局布线', '数字后端', '时序分析', '物理验证', '电源分析']/['平面规划', '时序收敛', '物理']/['Cadence', 'ICC2', 'Innovus'], F1=0.7000; bonus TP/FP/FN=[]/[]/['DDR', 'PCIE', 'PHY'], F1=0.0000; education=True
- r2_005: title raw=False, normalized=False; skills TP/FP/FN=['ByteTrack', 'C++', 'DeepSORT', 'NCNN', 'ONNX', 'OpenCV', 'PyTorch', 'Python', 'TensorRT', 'YOLO', '图像分割', '图像增强', '模型量化', '特征提取', '目标检测', '障碍物识别']/['剪枝', '去雾', '多目标跟踪', '防抖']/['目标跟踪'], F1=0.8649; bonus TP/FP/FN=['SLAM', '视觉定位', '语义分割']/[]/[], F1=1.0000; education=True
...
- r2_010: title raw=False, normalized=False; skills TP/FP/FN=['C++', 'Linux', 'Python', 'ROS', '力控', '导纳控制', '机器人动力学', '机器人运动学', '路径规划', '轨迹规划', '运动控制', '阻抗控制']/['ARM', 'EtherCAT', 'Twincat', 'X86', '人工智能']/[], F1=0.8276; bonus TP/FP/FN=['EtherCAT']/[]/['TwinCAT', '医疗机器人', '协作机器人', '手术机器人'], F1=0.3333; education=True
...
- r2_017: title raw=False, normalized=False; skills TP/FP/FN=['AGENT', 'CI/CD', 'Go', 'Java', 'Python', 'UI设计', 'VLM', '大语言模型', '检索增强生成']/['性能监控']/['Figma', '客户端', '知识库构建'], F1=0.8182; bonus TP/FP/FN=[]/['Figma', 'Sketch', 'UI设计']/[], F1=0.0000; education=True
