...
```json
{
  ...
  "skills_average_sample_f1": 0.7614454579907515,
  "bonus_skills_micro": {
    "tp": 52,
    "fp": 31,
    "fn": 21,
  ...
  "bonus_skills_average_sample_f1": 0.43392705247968405,
...
- r2_003: title raw=True, normalized=True; skills TP/FP/FN=['Apache Kafka', 'Docker', 'FastAPI', 'Kubernetes', 'LangChain', 'LlamaIndex', 'PyTorch', 'Python', 'Redis', 'Transformer', '检索增强生成', '模型量化']/['Agent开发', '向量数据库', '多模态', '推理加速']/['AGENT', 'Chroma', 'DeepSeek', 'Elasticsearch', 'GLM', 'Milvus', 'Qwen', 'TGI', 'vLLM'], F1=0.6486; bonus TP/FP/FN=['CUDA', 'Triton', '昇腾CANN']/['多模态']/['MindIE', 'OCR', 'VLM'], F1=0.6000; education=True
...
- r2_007: title raw=False, normalized=True; skills TP/FP/FN=['Excel', 'PPT', 'SQL', '数据建模', '数据清洗']/['指标体系搭建', '统计学']/['NumPy', 'Pandas', 'Python', '数仓建模', '数据分析', '数据可视化'], F1=0.5556; bonus TP/FP/FN=[]/['BI报表', 'NumPy', 'Pandas', 'Python', '可视化']/['BI', '指标体系', '数据挖掘'], F1=0.0000; education=True
- r2_008: title raw=True, normalized=True; skills TP/FP/FN=['Docker', 'FastAPI', 'LangChain', 'LlamaIndex', 'LoRA', 'Milvus', 'MySQL', 'OCR', 'PyTorch', 'Python', 'QLoRA', 'Redis', 'TensorFlow', 'pgvector', '向量检索', '提示工程', '检索增强生成', '自然语言处理']/['模型微调', '模型推理']/['AGENT', 'OpenAI API', '大语言模型'], F1=0.8780; bonus TP/FP/FN=['SFT微调']/['Agent开发', '大模型量化']/['医药行业大模型', '显存', '模型量化'], F1=0.2857; education=True
...
- r2_011: title raw=False, normalized=False; skills TP/FP/FN=['C++', 'Jetson', 'Linux', 'MAVROS', 'Navigation2', 'OpenCV', 'PCL', 'PX4', 'Python', 'ROS', 'SLAM', '路径规划', '运动控制']/['CI/CD', 'DDS', 'Git', '多传感器数据融合']/['传感器融合', '卡尔曼滤波', '激光雷达'], F1=0.7879; bonus TP/FP/FN=[]/[]/[], F1=0.0000; education=True
- r2_012: title raw=True, normalized=True; skills TP/FP/FN=['C++', 'CLIP', 'CNN', 'GAN', 'Java', 'OpenCV', 'Python', 'SAM', 'Transformer', '大语言模型', '扩散模型']/[]/['图像分割', '图像分类', '模型轻量化', '目标检测'], F1=0.8462; bonus TP/FP/FN=[]/[]/[], F1=0.0000; education=False
- r2_013: title raw=False, normalized=False; skills TP/FP/FN=['C++', 'Python', '三维重建', '传感器融合', '多视几何', '摄影测量']/['光束平差法', '多线程', '性能调优', '深度学习', '特征匹配', '特征提取', '畸变校准']/['CNN', 'GPU加速', 'LiDAR', 'OpenCV', 'OpenMVS', 'PyTorch', 'SFM', 'Transformer', '光束平差', '密集匹配', '特征提取与匹配', '畸变校正', '相机标定'], F1=0.3750; bonus TP/FP/FN=[]/['GPU加速', '内存', '多线程']/[], F1=0.0000; education=True
...
- r2_017: title raw=False, normalized=False; skills TP/FP/FN=['AGENT', 'CI/CD', 'Figma', 'Go', 'Java', 'Python', 'VLM', '大语言模型', '检索增强生成']/['Sketch']/['UI设计', '客户端', '知识库构建'], F1=0.8182; bonus TP/FP/FN=[]/['Figma', 'Sketch']/[], F1=0.0000; education=True
- r2_018: title raw=False, normalized=False; skills TP/FP/FN=['Git', 'MySQL', 'PostgreSQL', 'Python', '多线程', '并发编程', '并行计算', '异步编程', '高性能计算']/['性能分析', '性能调优', '数据库', '版本控制']/[], F1=0.8182; bonus TP/FP/FN=['AWS', 'Azure', 'Django', 'FastAPI', 'Flask', 'GCP', '单元测试']/['Agile', 'SDLC', '契约测试', '性能分析', '性能调优', '集成测试']/[], F1=0.7000; education=True
...
- r2_020: title raw=False, normalized=True; skills TP/FP/FN=['C++', 'Linux', 'OCR', 'OpenCV', 'Python', '人体姿态估计', '人脸识别', '多模态模型', '少样本学习', '度量学习', '模型量化', '目标检测', '目标跟踪', '自监督学习', '表情分析', '视频动作检测', '迁移学习']/['NPU推理', '内存', '多线程', '模型部署', '深度学习', '目标分割', '缓存']/['ONNX', 'RKNN', '图像分割', '嵌入式部署', '视频行为理解'], F1=0.7391; bonus TP/FP/FN=['ISP', 'MNN', 'NCNN', 'OpenVINO', 'TensorRT', 'VLM', '大语言模型', '强化学习']/['LMM', 'RKNN', '相机采集']/[], F1=0.8421; education=True

## Lowest three skill-F1 cases

- r2_013: skills F1=0.3750; FP=['光束平差法', '多线程', '性能调优', '深度学习', '特征匹配', '特征提取', '畸变校准']; FN=['CNN', 'GPU加速', 'LiDAR', 'OpenCV', 'OpenMVS', 'PyTorch', 'SFM', 'Transformer', '光束平差', '密集匹配', '特征提取与匹配', '畸变校正', '相机标定']
- r2_009: skills F1=0.5000; FP=['功能测试', '大模型测试', '安全性测试', '性能测试']; FN=['大语言模型', '软件测试']
- r2_007: skills F1=0.5556; FP=['指标体系搭建', '统计学']; FN=['NumPy', 'Pandas', 'Python', '数仓建模', '数据分析', '数据可视化']
