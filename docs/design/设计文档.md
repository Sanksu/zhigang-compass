...
![系统总览](mermaid-01-系统总览.png)

<!-- Mermaid 源码（思维导图/可编辑工具可用）：
```mermaid
flowchart LR
...
>
> **平台 A/B/C 分级管理**：
> - **A 级（P0 主力，稳定源）**：BOSS、智联、Monster —— 3 平台保底 P0 单日 ≥ 60 条。**[注意] 08.06 Monster 停采**（DataDome 不可绕过，见 §4.3 平台表），保底由 BOSS/智联承担
