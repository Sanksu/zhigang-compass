...
NARRATIONS = [
    ...
    "知识图谱是系统核心载体，在Neo4j中构建了岗位、技能、课程等多类实体与关系，十五个岗位职能域由大模型语义命名。",
    "大模型抽取构建了幻觉防控三道防线：Schema强校验、词典过滤、证据链可追溯。一百一十条黄金集盲评F1达零点九六二九。",
    ...
    "前端采用React 19加ECharts，默认2D力导向图百节点六十帧，3D模式动态加载，支持四视图切换与响应式适配。",
    ...
    "四项核心指标全部达标：JD解析零点九六二九、匹配零点八九零六、学习路径九六点七、性能P95四百三十毫秒。",
